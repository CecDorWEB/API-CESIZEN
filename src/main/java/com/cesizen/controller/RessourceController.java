...
public class RessourceController {
	 ...
	 * 
	 * @PostMapping public RessourceDTO createRessource(@RequestBody RessourceDTO
	 * ressourceDTO) { Ressource ressource =
	 * ressourceServices.toEntity(ressourceDTO); Ressource savedRessource =
	 * ressourceServices.saveRessource(ressource);
	 * 
